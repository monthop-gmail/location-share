-- Baseline: schema ของ production ณ commit e79616b (ก่อน migration ชุดใหม่)
--
-- ใช้เป็นจุดตั้งต้นของ tests/migrations.sh เท่านั้น ไม่ต้องรันกับโปรเจกต์จริง
-- ห้ามแก้ให้ตรงกับ schema ปัจจุบัน — จุดประสงค์คือจำลอง "ของเดิมที่ยังไม่ได้ย้าย"
-- เพื่อพิสูจน์ว่า migrations/ พาไปถึงปลายทางได้จริง
